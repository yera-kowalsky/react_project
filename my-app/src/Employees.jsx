...
const Employees = () => {
    ...
    function handleEmployeeCardClick(event){
        const transformedEmployees = empolyees.map((empolyee) => empolyee.id === parseInt(event.currentTarget.id)
                                                  ?(empolyee.teamName === selectedTeam)?{...empolyee, teamName:''}:{...empolyee,
                                                  teamName: selectedTeam}:empolyee);
